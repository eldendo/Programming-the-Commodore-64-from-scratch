...
4130 ai=56:rem number(aantal) of instructions
...
6020 next i
6030 if name$="a" or name$="x" or name$="y" or name$="org" then sy$=name$
6040 return
...
6225 if sy$="=" then gosub 6270:rem bind label to value
6227 if sy$="org" then gosub 5800:gosub 7000:lc=num
6230 if sy$<>"eol" then ex$="eol":goto 5400 
6250 gosub 5800:rem getsym
6260 return

6270 rem *** bind label ***
6280 gosub 5800:gosub 7000: rem getsym,get value
6285 rem print "***";num;la$(lp-1)
6290 if pa=1 then la(lp-1)=num:rem bind last defined label to num
6295 return
